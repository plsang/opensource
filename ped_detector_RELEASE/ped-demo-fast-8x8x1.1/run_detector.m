...
offh=0; offw=0;
tic;
[feats,nwin_posw1,nwin_posh1,nwinw1,nwinh1] =  compute_features_fast(image,nori, ...
                                            full_360,border, ...
                                            window_size, ...
                                            block_sizes, ...
                                            nlevels,strideh, ...
                                            stridew, ...
                                            scaleratio,offh,offw);
...
offh=8; offw=0;
[feats,nwin_posw2,nwin_posh2,nwinw2,nwinh2] =  compute_features_fast(image,nori, ...
                                          full_360,border, ...
                                            window_size, ...
                                            block_sizes, ...
                                            nlevels,strideh, ...
...
offh=0; offw=8;
[feats,nwin_posw3,nwin_posh3,nwinw3,nwinh3] =  compute_features_fast(image,nori, ...
                                            full_360,border, ...
                                            window_size, ...
                                            block_sizes, ...
                                            nlevels,strideh, ...
...
offh=8; offw=8;
[feats,nwin_posw4,nwin_posh4,nwinw4,nwinh4] =  compute_features_fast(image,nori, ...
                                            full_360,border, ...
                                            window_size, ...
                                            block_sizes, ...
                                            nlevels,strideh, ...
                                            stridew,scaleratio,offh,offw);
feature_time = feature_time + toc;
