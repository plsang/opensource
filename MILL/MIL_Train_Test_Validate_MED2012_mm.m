...
function run = MIL_Train_Test_Validate_MED2012_mm(input_file, classifier_wrapper_handle, classifier)
    ...
    output_dir = sprintf('/net/per610a/export/das11f/plsang/trecvidmed12/experiments/MIL/%s', feat_name);
    ...
    for ii=preprocess.start_event:preprocess.end_event,
        [bags, num_data, num_feature, trainindex, testindex] = Load_MED2012(MEDMD, preprocess.max_neg, ii);
...
function [bags, num_data, num_feature, trainindex, testindex] = Load_MED2012(medmd, max_neg, event_id)
